...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-base font-bold text-gray-800">Informasi Paket</h2>
        ...
        <form method="POST" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm transition-colors outline-none focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-100 resize-none">{{ old('description') }}</textarea>
                @error('description')
            ...
            <div>
                ...
                <input type="file" name="thumbnail" id="thumbnail" accept=".jpg,.jpeg,.png"
                       class="w-full text-sm text-gray-600
                              ...
                              hover:file:bg-green-100 border border-gray-200 rounded-xl px-2 py-1.5">
                @error('thumbnail')
                    <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
